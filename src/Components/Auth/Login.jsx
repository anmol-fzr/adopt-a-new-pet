        ...
        <section className="bg-gray-200 min-h-screen flex items-center justify-center">
            <div className="bg-gray-50 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                ...
                <div className="w-full px-8 md:px-16">
                    ...
                    <button onClick={googleSignIn} className="bg-white border p-2 w-full rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 text-[#002D74]">
